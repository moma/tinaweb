...
$sql = "SELECT * FROM scholars where tags LIKE '%#wehia%' ORDER BY last_name";
...
<a href="http://eshia.bwl.uni-kiel.de/"><img src="http://eshia.bwl.uni-kiel.de/img/eshia07.png" align="center"></a>
<br/><br/>
<br/>
<br/>
<p>
This directory presents the members of the network of Wehia conferences participants, organized by 
the <a href="http://eshia.bwl.uni-kiel.de/" target="blank">the Society for Economic Science with Heterogeneous Interacting Agents</a> (ESHIA): <a href="#scholars">'.  count($scholars).' scholars</a> belonging to <a href="#labs">'
.  count($labs).' labs</a> and <a href="#orga">'.$orga_count.' organizations</a> working in
the field of Complex Systems.';
$header .='
    
<ul>
<li><b><i>This directory is open to all participants to WEHIA conferences</i></b>. Is is elaborated by ESHIA in collaboration with the Complex SYstems Society. Personal data are given on a
voluntary basis and people are responsible for the validity and integrity of their data.
<li><strong>Your are not in this directory ?</strong> Add the community tag #wehia in your <a href="http://main.csregistry.org/Whoswhodata" target="blank">complex systems profile</a>.
</ul> 
</p>
