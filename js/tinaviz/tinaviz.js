...
Tinaviz = (function() {
  ...
  function Tinaviz() {
    ...
    this.configure_using = __bind(this.configure_using, this);
    this.applet = void 0;
    this.config = {
  ...
  Tinaviz.prototype._resize = function(_arg) {
    ...
    if ((_ref = this.applet) != null) {
      _ref.height = height;
    }
    if ((_ref1 = this.applet) != null) {
      _ref1.width = width;
    }
    return (_ref2 = this.applet) != null ? typeof _ref2.resize === "function" ? _ref2.resize(width, height) : void 0 : void 0;
  };
