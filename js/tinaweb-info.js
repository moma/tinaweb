        ...
        updateInfo: function(lastselection) {
            ...
            for(var id in lastselection) {
                ...
                if (node.category == current_cat)  {
                    ...
                    // MODIF DAVID
                    // current_cat = tinaviz.get("category/category");  /// category courante
                    if (current_cat !== undefined) {
                        ...
                        if ( CurrentCategRealName == "NGram"
                            | CurrentCategRealName == "keywords"
                            | CurrentCategRealName == "Keywords"
                            | CurrentCategRealName == "Terms"
                            | CurrentCategRealName == "Communities") {
                            contentinnerdiv.append(
                                $("<p></p>").html(
                        ...
                        if (CurrentCategRealName == "Scholars"
                            |CurrentCategRealName == "People"
                            |CurrentCategRealName == "scholars"){
                            contentinnerdiv.append(
                                $("<p></p>").html(
                                    '<a href="http://www.google.com/#hl=en&source=hp&q=%20'
                                    + SearchQuery
