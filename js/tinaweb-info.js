...
InfoDiv.prototype.display_current_category = function() {
...
InfoDiv.prototype.display_current_view=function(){
...
InfoDiv.prototype.updateTagCloud=function(viewLevel){
...
//InfoDiv.prototype.test=function(string){
//    alert('this is' + string);
//  }

InfoDiv.prototype.updateInfo=function(lastselection){
...
InfoDiv.prototype.getContent=function(node){
    /* Methodes*/
    return decHTMLifEnc(jQuery.trim(decodeJSON(node.content)));
}

InfoDiv.prototype.getLabel=function(node){
    /* Methodes*/
    return jQuery.trim(decodeJSON(node.label));
}

InfoDiv.prototype.update=function(view, lastselection){
...
InfoDiv.prototype.reset=function(){
...
InfoDiv.prototype.updateNodeList=function(node_list, category){
    /* Init the node list */
...
InfoDivPhyloweb.prototype = new InfoDiv(InfoDivPhyloweb.id);

// Tout le prototype fille est remplacÈ par celui de la mËre
InfoDivPhyloweb.prototype.display_current_category=InfoDiv.prototype.display_current_category;
InfoDivPhyloweb.prototype.display_current_view=InfoDiv.prototype.display_current_view;
InfoDivPhyloweb.prototype.updateTagCloud=InfoDiv.prototype.updateTagCloud;
InfoDivPhyloweb.prototype.updateInfo=InfoDiv.prototype.updateInfo;
InfoDivPhyloweb.prototype.update=InfoDiv.prototype.update;
InfoDivPhyloweb.prototype.reset=InfoDiv.prototype.reset;
InfoDivPhyloweb.prototype.updateNodeList=InfoDiv.prototype.updateNodeList;
